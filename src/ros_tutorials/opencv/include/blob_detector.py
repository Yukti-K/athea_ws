...
def blob_detect(image,                  #-- The frame (cv standard)
                hsv_min=[46,15,81],                #-- minimum threshold of the hsv filter [h_min, s_min, v_min]
                hsv_max=[81,216,255],                #-- maximum threshold of the hsv filter [h_max, s_max, v_max]
...
#def displayD435():
#    rospy.init_node('D435_display', anonymous=True)
#    global count,bridge
#    count = 0
#    bridge = CvBridge()
...
if __name__=="__main__":
    ...
    if SOURCE == 'video':
        ...
        ret, frame = cv_image
            ...
            #-- Detect keypoints
        keypoints, _ = blob_detect(frame, green_min, green_max, blur=3, 
        ...
        image_list = []
        image_list.append(cv2.imread("green_ball.jpg"))
        #image_list.append(cv2.imread("blob2.jpg"))
        #image_list.append(cv2.imread("blob3.jpg"))

        for image in image_list:
            #-- Detect keypoints
            keypoints, _ = blob_detect(image, green_min, green_max, blur=5, 
